...
export function buildProGateEmail4(
  ...
  <p style="font-size: 15px; color: #334155;">While you're benchmarking manually, teams at mid-cap biotechs, Big Pharma licensing groups, and boutique advisory firms are getting instant deal intelligence backed by ${DEAL_STATS.TOTAL_DEALS} tracked transactions, ${DEAL_STATS.VERIFIED_DEALS} verified with source citations.</p>
