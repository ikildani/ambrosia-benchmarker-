...
export const COMPARABLE_DEALS: ComparableDeal[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════
  // REFORMULATION / 505(b)(2) — verified deals 2017-2026 (SEC filings + press releases)
  // Every deal below is traceable to a primary source. Additional comps
  // cross-match from licensing deals via hedonic scorer partial credit.
  // ═══════════════════════════════════════════════════════════════════════

  // Eagle SEC 8-K (Sep 2017); BioSpace press release; Eagle 10-Q FY2017
  { licensor: 'Eagle Pharmaceuticals', licensee: 'SymBio Pharmaceuticals', value: '$17.5M+', totalValueM: 18, upfrontM: 12.5, milestonesM: 5, royaltyRange: 'undisclosed royalties on net sales', year: 2017, relevance: 'TREAKISYM RTD+RI (bendamustine reformulations) 505(b)(2) license for Japan', dealType: 'reformulation', modalities: ['smallMolecule'], indications: ['dlbcl'], therapeuticArea: 'oncology', phase: 'approved', territory: 'japan', source: 'Eagle SEC 8-K (Sep 2017); BioSpace; Eagle 10-Q FY2017; $12.5M upfront, $5M NDA approval milestone' },
  // Baudax Bio SEC 8-K (Nov 2019); GlobeNewswire (Nov 21, 2019); APIL license assignment
  { licensor: 'Recro Pharma/APIL', licensee: 'Baudax Bio', value: '$140M', totalValueM: 140, royaltyRange: '10-12% of net sales', year: 2019, relevance: 'ANJESO (IV meloxicam) 505(b)(2) — oral-to-IV reformulation for pain management, spun off with earn-out', dealType: 'reformulation', modalities: ['smallMolecule'], indications: ['chronicPain'], therapeuticArea: 'neurology', phase: 'nda_filed', territory: 'global', source: 'Baudax Bio SEC 8-K (Nov 2019); GlobeNewswire; up to $140M earn-out + 10-12% net sales; FDA approved Feb 2020' },
  // Xeris IR press release (Jul 19, 2021); Drug Delivery Business "$71M agreement"
  { licensor: 'Xeris Pharmaceuticals', licensee: 'Tetris Pharma', value: '$71M', totalValueM: 71, royaltyRange: 'mid-single digit', year: 2021, relevance: 'Ogluo (glucagon injection) license for EEA/UK/CH — ready-to-use reformulation', dealType: 'reformulation', modalities: ['peptide'], indications: ['type2Diabetes'], therapeuticArea: 'metabolic', phase: 'approved', territory: 'europe', source: 'Xeris IR press release (Jul 19, 2021); Drug Delivery Business' },
  // Amneal IR press release (Mar 2021); Fierce Pharma "$70M buyout"; Amneal SEC 8-K
  { licensor: 'Kashiv Specialty Pharmaceuticals', licensee: 'Amneal Pharmaceuticals', value: '$108M', totalValueM: 108, upfrontM: 70, milestonesM: 38, royaltyRange: 'undisclosed', year: 2021, relevance: 'Kashiv 505(b)(2) pipeline acquisition — neurology/endocrinology branded products + complex generics', dealType: 'reformulation', modalities: ['smallMolecule'], therapeuticArea: 'neurology', phase: 'phase2', territory: 'global', source: 'Amneal IR (Mar 2021); Fierce Pharma; $70M at close, $30M year-1, up to $8M regulatory milestones' },
  // Collegium SEC 8-K (Mar 2026); GlobeNewswire (Mar 19, 2026); completed May 12, 2026
  { licensor: 'Corium Therapeutics', licensee: 'Collegium Pharmaceutical', value: '$785M', totalValueM: 785, upfrontM: 650, milestonesM: 135, royaltyRange: 'N/A (acquisition)', year: 2026, relevance: 'AZSTARYS (serdexmethylphenidate/dexmethylphenidate) 505(b)(2) ADHD acquisition — prodrug reformulation, patent to 2037', dealType: 'reformulation', modalities: ['smallMolecule'], indications: ['adhd'], therapeuticArea: 'neurology', phase: 'approved', territory: 'us_only', source: 'Collegium SEC 8-K (Mar 2026); GlobeNewswire; $650M cash + up to $135M milestones; 760K+ Rx in 2025' },
  // Pacira IR press release (Jan 13, 2026); GlobeNewswire; Yahoo Finance
  { licensor: 'Pacira BioSciences', licensee: 'LG Chem', value: 'undisclosed', totalValueM: 0, royaltyRange: 'tiered royalties + transfer price', year: 2026, relevance: 'EXPAREL (bupivacaine liposome injectable) license for Asia-Pacific — DepoFoam extended-release reformulation', dealType: 'reformulation', modalities: ['smallMolecule'], indications: ['chronicPain'], therapeuticArea: 'neurology', phase: 'approved', territory: 'japan', source: 'Pacira IR press release (Jan 13, 2026); GlobeNewswire; undisclosed upfront + transfer price + tiered royalties' },
  // BDSI SEC 8-K (Jan 2012); PRNewswire (Feb 2015 NDA acceptance $10M, Oct 2015 FDA approval $50M); BDSI 10-K
  { licensor: 'BioDelivery Sciences', licensee: 'Endo Pharmaceuticals', value: '$180M', totalValueM: 180, upfrontM: 30, milestonesM: 150, royaltyRange: 'mid-to-upper teen', year: 2012, relevance: 'BELBUCA (buprenorphine buccal film) 505(b)(2) — novel delivery for chronic pain, oral-to-buccal reformulation', dealType: 'reformulation', modalities: ['smallMolecule'], indications: ['chronicPain'], therapeuticArea: 'neurology', phase: 'phase3', territory: 'global', source: 'BDSI SEC 8-K (Jan 2012); PRNewswire: $10M NDA acceptance (Feb 2015), $50M FDA approval (Oct 2015); mid-to-upper teen royalties' },
  // Acorda IR press release (Sep 24, 2014); Boston Globe; Fierce Pharma; FDA approval letter (Dec 21, 2018)
  { licensor: 'Civitas Therapeutics', licensee: 'Acorda Therapeutics', value: '$525M', totalValueM: 525, upfrontM: 525, royaltyRange: 'N/A (acquisition)', year: 2014, relevance: 'INBRIJA (levodopa inhalation powder) 505(b)(2) — oral-to-inhaled reformulation for Parkinson OFF episodes via ARCUS pulmonary tech', dealType: 'reformulation', modalities: ['smallMolecule'], indications: ['parkinsons'], therapeuticArea: 'neurology', phase: 'phase3', territory: 'global', source: 'Acorda IR (Sep 24, 2014); Boston Globe "$525M"; Fierce Pharma; 505(b)(2) NDA referencing Sinemet; FDA approved Dec 2018' },
  // Opiant SEC 10-K/10-Q; IR press releases; Adapt Pharma license Dec 2014
  { licensor: 'Opiant Pharmaceuticals', licensee: 'Adapt Pharma', value: '$55M+', totalValueM: 55, royaltyRange: 'double-digit', year: 2014, relevance: 'NARCAN Nasal Spray (naloxone) 505(b)(2) — IV-to-nasal reformulation for opioid overdose', dealType: 'reformulation', modalities: ['smallMolecule'], indications: ['substanceUseDisorder'], therapeuticArea: 'neurology', phase: 'phase3', territory: 'global', source: 'Opiant SEC 10-K; Opiant IR press releases; >$55M milestones + double-digit royalties; Adapt acquired by Emergent $735M (2018)' },
  // Eagle SEC 8-K (Feb 17, 2015); Teva USA press release; Fierce Biotech "$120M pact"
  { licensor: 'Eagle Pharmaceuticals', licensee: 'Cephalon/Teva', value: '$120M', totalValueM: 120, upfrontM: 30, milestonesM: 90, royaltyRange: '25-32%', year: 2015, relevance: 'BENDEKA (bendamustine rapid infusion) 505(b)(2) — 10-min IV vs. Treanda 60-min', dealType: 'reformulation', modalities: ['smallMolecule'], indications: ['dlbcl'], therapeuticArea: 'oncology', phase: 'approved', territory: 'us_only', source: 'SEC 8-K (Feb 17, 2015); Teva USA press release; Fierce Biotech; royalties 25% rising to 32%' },
  // Zogenix SEC 8-K (Apr 2015); GlobeNewswire (Mar 10, 2015); Fierce Pharma
  { licensor: 'Zogenix', licensee: 'Pernix Therapeutics', value: '$383M', totalValueM: 383, upfrontM: 70, milestonesM: 283, royaltyRange: 'undisclosed', year: 2015, relevance: 'Zohydro ER (hydrocodone) 505(b)(2) extended-release franchise + ADF pipeline (ZX-007)', dealType: 'reformulation', modalities: ['smallMolecule'], indications: ['chronicPain'], therapeuticArea: 'neurology', phase: 'approved', territory: 'us_only', source: 'Zogenix SEC 8-K (Apr 2015); GlobeNewswire; $70M cash + 1.68M shares, $12.5M ZX-007 approval, $271M sales milestones' },
];
...
export function scoreComparableDealsHedonic(
  ...
  const scored = ALL_DEALS.map((deal, idx) => {
    ...
    // --- Deal type match ---
    // Reformulation is structurally a licensing sub-type: exact match gets
    // full points, but reformulation↔licensing also gets partial credit so
    // the comp set isn't artificially narrowed to only 16 reformulation deals.
    let dealTypeScore = 0;
    if (inputs.dealType && deal.dealType === inputs.dealType) {
      dealTypeScore = 3;
      reasons.push('Same deal structure');
    } else if (
      (inputs.dealType === 'reformulation' && deal.dealType === 'licensing') ||
      (inputs.dealType === 'licensing' && deal.dealType === 'reformulation')
    ) {
      dealTypeScore = 2;
      reasons.push('Related deal structure (licensing / reformulation)');
    }
