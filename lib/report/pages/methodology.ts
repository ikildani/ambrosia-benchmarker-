        ...
        <div>
          ...
          <div class="card" style="font-size: 10px; color: ${COLORS.gray700}; line-height: 1.7;">
            <p style="margin-bottom: 7px;">
              The Ambrosia Deal Benchmarker uses a proprietary multi-factor valuation model calibrated against 2,600+ publicly disclosed pharmaceutical licensing transactions from 2017\u20132026.
            </p>
            <p style="margin-bottom: 7px;">
