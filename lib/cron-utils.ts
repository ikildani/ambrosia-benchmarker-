...
export const SOURCES_EXPECTING_RECORDS: ReadonlySet<string> = new Set([
  ...
  'edgar_fts_backfill', 'hkex_announcements', 'hkex_backfill', 'tdnet_announcements', 'asx_announcements', 'dart_announcements', 'cninfo_announcements', 'mfn_announcements', 'deal_resourcing', 'sec_10k_ingest', 'deal_verification',
]);
