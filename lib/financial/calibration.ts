...
export const CALIBRATION_DEALS: CalibrationDeal[] = [
  ...
  // R71 Fix #3 — Failed / stranded asset corpus. Reference entries (no deal
  // closed) documenting the post-bust down-calibration for specific asset
  // classes. Marked with cal_fail_* prefix. actualUpfront=0, actualTotalDeal
  // set to the public-proxy valuation (e.g., market cap at collapse, last
  // disclosed partnership terms that fell through). These should weight the
  // corpus AWAY from pre-bust optimistic pricing for these indications.
  { id: 'cal_fail_001', year: 2024, licensor: 'bluebird bio', licensee: 'Stranded (no deal)', therapeuticArea: 'rareDisease', modality: 'geneTherapyRare', indication: 'beta_thalassemia', phase: 'approved', territory: 'global', actualUpfront: 0, actualTotalDeal: 250, estimatedPeakSales: 150, biomarkerSelected: false, designations: ['orphan'], competitivePosition: 'firstInClass', description: 'REFERENCE — Zynteglo launch collapse; market cap fell to $250M late 2024. Documents gene therapy rare disease down-calibration post-2022 bust.' },
  { id: 'cal_fail_002', year: 2023, licensor: 'Uniqure', licensee: 'CSL (deal renegotiated)', therapeuticArea: 'rareDisease', modality: 'geneTherapyRare', indication: 'hemophilia_b', phase: 'approved', territory: 'global', actualUpfront: 450, actualTotalDeal: 2000, estimatedPeakSales: 500, biomarkerSelected: false, designations: ['orphan', 'breakthrough'], competitivePosition: 'firstInClass', description: 'REFERENCE — Original Uniqure-CSL deal $3B+ renegotiated down after commercial launch disappointment. Hemgenix actual deal value substantially below pre-launch expectations.' },
  { id: 'cal_fail_003', year: 2022, licensor: 'Inovio INO-3107', licensee: 'No deal closed', therapeuticArea: 'infectiousDisease', modality: 'therapeuticVaccine', indication: 'hpv_rrp', phase: 'phase2', territory: 'global', actualUpfront: 0, actualTotalDeal: 100, estimatedPeakSales: 200, biomarkerSelected: false, designations: ['fastTrack'], competitivePosition: 'firstInClass', description: 'REFERENCE — INO-3107 for HPV-related respiratory papillomatosis never licensed despite positive Phase 2 data. DNA vaccine asset class depressed deal values.' },
  { id: 'cal_fail_004', year: 2023, licensor: 'Rocket Pharmaceuticals', licensee: 'FDA CRL (stranded)', therapeuticArea: 'rareDisease', modality: 'geneTherapyRare', indication: 'fanconi_anemia', phase: 'phase3', territory: 'global', actualUpfront: 0, actualTotalDeal: 400, estimatedPeakSales: 200, biomarkerSelected: false, designations: ['orphan', 'breakthrough'], competitivePosition: 'firstInClass', description: 'REFERENCE — Rocket Kresladi LAD-I gene therapy CRL mid-2024; market cap deflated to ~$400M. Documents rare-pediatric gene therapy disappointing outcomes.' },
  { id: 'cal_fail_005', year: 2024, licensor: 'Editas Medicine', licensee: 'Stranded (partnership dissolved)', therapeuticArea: 'rareDisease', modality: 'geneTherapyRare', indication: 'sickleCell', phase: 'phase1_2', territory: 'global', actualUpfront: 0, actualTotalDeal: 350, estimatedPeakSales: 300, biomarkerSelected: false, designations: ['orphan'], competitivePosition: 'racing', description: 'REFERENCE — Editas EDIT-301 sickle cell program priced at modest valuation post-Casgevy approval dominance. Post-bust gene editing.' },
];
