    ...
    projects: [
      {
        ...
        testMatch: [
          ...
          '<rootDir>/__tests__/ta-share-multiplier.test.ts',
        ],
      ...
      },
      {
        ...
        displayName: 'lib',
        testEnvironment: 'node',
        testMatch: ['<rootDir>/__tests__/lib/**/*.test.ts', '<rootDir>/__tests__/ingestion/**/*.test.ts', '<rootDir>/__tests__/brief/**/*.test.ts'],
      },
    ],
  };
};
