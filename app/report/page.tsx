...
const reportModules = [
  ...
  },
  {
    ...
    subtitle: 'Monte Carlo + tornado analysis',
    description: 'How your deal economics shift across pricing, market share, and timeline scenarios. rNPV modeling with probability-weighted outcomes.',
    highlight: '3x3 scenario matrix',
    color: 'rose',
  },
  {
    icon: Scale,
