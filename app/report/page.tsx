            ...
            <div className="relative bg-gradient-to-b from-teal-500/[0.04] to-[#0c1220]/60 border border-teal-500/[0.12] rounded-xl p-8">
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  'rNPV with peak sales validation vs 164 index drugs',
