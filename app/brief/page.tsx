...
const PAGES: Array<{ n: string; title: string; text: string }> = [
  ...
  { n: '06', title: 'Valuation bridge', text: 'Cited comparables, the calibrated range and risk-adjusted value reconciled to one ask, with the policy printed and the headline built up from its baseline and every modifier.' },
  ...
  { n: '14', title: 'Path to the next inflection', text: 'Partner now versus fund to the next readout, using your real cash and raise.' },
  { n: '15', title: 'Buyer map', text: 'Counterparties ranked on fit, urgency and what each paid at your stage; the buyers you name assessed on the same terms.' },
  { n: '18', title: 'Catalyst calendar', text: 'Twenty-four months of readouts, LOEs and buyer events, and the window the recommendation rests on.' },
  { n: '19', title: 'Positioning, objections, diligence', text: 'How to present it, the objections you will hear with the evidence to answer them, and what is ready versus open.' },
];
          ...
          <div>
            ...
            <dl className="mt-10 grid grid-cols-2 gap-x-8 gap-y-5 border-t border-slate-800/80 pt-6 sm:grid-cols-4">
              {[
                ...
                ['20', 'decision pages, plus the appendix'],
      ...
      <section id="pages" className="border-b border-slate-800/60">
        <div className="mx-auto max-w-6xl px-6 py-20">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 font-display text-3xl font-semibold tracking-tight text-slate-50">Twenty decision pages, each built from cited data or from what you tell us, with the engine detail and every source in an appendix.</h2>
