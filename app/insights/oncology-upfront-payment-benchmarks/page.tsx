...
export const metadata: Metadata = {
  ...
  description: 'Oncology licensing deal upfronts range from $14M at discovery to $800M for approved assets. Benchmark data across 7 development phases and 8 modalities from 2,500+ real transactions.',
  keywords: [
  ...
  twitter: {
    ...
    description: 'Benchmark data across 7 development phases and 8 modalities from 2,500+ real biopharma transactions.',
  },
  alternates: {
      ...
      <main className="min-h-screen bg-white">
        ...
        <header className="bg-white border-b border-slate-200">
          ...
          <div className="max-w-4xl mx-auto px-6 pt-14 pb-14">
            ...
            <p className="text-lg text-slate-500 max-w-2xl leading-relaxed">Oncology upfronts range 57x from discovery to approval. Here is the benchmark data across 7 development phases and 8 modalities from 2,500+ real transactions.</p>
          </div>
        </header>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <GatedBenchmarkTable
            ...
            ctaHref="/calculator"
            footnote="Source: Ambrosia Benchmarker, 2,500+ transactions 2020-2026. Median values."
          />
        </div>
        ...
        <InsightCTA
          ...
          description="Model upfronts, milestones, and royalties by phase, modality, and indication — powered by 2,500+ real oncology transactions."
        />
      </main>
      <SiteFooter />
    </>
