...
export const metadata: Metadata = {
  ...
  description: 'Analysis of 3,400+ biotech out-licensing deals reveals benchmark terms for licensing, acquisition, co-development, option, and collaboration structures across all major therapeutic areas.',
  keywords: [
  ...
  openGraph: {
    ...
    description: '3,400+ deals analyzed. Benchmark terms for licensing, acquisition, co-dev, option, and collaboration structures.',
    type: 'article',
...
export default function BiotechOutLicensingPage() {
  ...
  const articleSchema = {
    ...
    description: 'Analysis of 3,400+ biotech out-licensing deals reveals benchmark terms for licensing, acquisition, co-development, option, and collaboration structures.',
      ...
      <main className="min-h-screen bg-white">
        ...
        <header className="bg-white border-b border-slate-200">
          ...
          <div className="max-w-4xl mx-auto px-6 pt-14 pb-14">
            ...
            <p className="text-lg text-slate-500 max-w-2xl leading-relaxed">What 3,400+ biopharma transactions reveal about deal structure, upfronts, milestones, and royalties across 5 deal types and 12 therapeutic areas.</p>
          </div>
        </header>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <GatedBenchmarkTable
            ...
            ctaHref="/calculator"
            footnote="Source: Ambrosia Benchmarker, 3,400+ transactions 2020-2026."
          />
        </div>
        ...
        <InsightCTA
          ...
          description="Compare licensing, co-development, option, and collaboration economics for your specific asset — powered by 3,400+ real transactions."
        />
      </main>
      <SiteFooter />
    </>
