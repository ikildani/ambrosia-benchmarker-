...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Benchmark royalty data by phase, modality, and TA from 2,600+ biopharma deals. Includes real disclosed terms from BridgeBio/Astellas, Alnylam/Roche, and more.',
    type: 'article',
    url: PAGE_URL,
  ...
  twitter: {
    ...
    description: 'Benchmark royalty data by phase and modality from 2,600+ biopharma deals.',
  },
  alternates: {
    canonical: PAGE_URL,
  },
...
export default function PharmaLicensingRoyaltyRatesPage() {
  ...
  const datasetSchema = {
    ...
    description: 'Royalty rate benchmark data for biopharma licensing deals across 7 development phases and 8 drug modalities, derived from 2,600+ transactions (2018-2026).',
    url: PAGE_URL,
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        <InsightPageHeader
          ...
          titleAccent={{ text: 'Royalty Rates', color: 'text-blue-400' }}
          subtitle="Royalties range from 3% at discovery to 25% for approved assets. We break down what drives the spread across 2,600+ biopharma deals."
          badge="Data Report"
          readTime="12 min read"
          stats={[
            { value: '3%-25%', label: 'Full royalty range' },
            { value: '7', label: 'Phases benchmarked' },
            { value: '8', label: 'Modalities compared' },
          ]}
          breadcrumbLabel="Royalty Rates"
        />
        ...
        <article className="max-w-3xl mx-auto px-4 py-12">
          ...
          <GatedBenchmarkTable
            ...
            ctaHref="/#pricing"
            footnote="Source: Ambrosia Ventures analysis of 2,600+ biopharma licensing deals (2018-2026). Royalty ranges represent observed 25th-75th percentile."
          />
          ...
          <InsightCallout title="Modality vs. mechanism: which matters more?">
            <p>
          ...
          <InsightCTA
            ...
            description="Input your phase, modality, and therapeutic area to see benchmark royalty rates from 2,600+ comparable transactions."
          />
          ...
          <InsightCallout title="Key takeaway for licensors">
            <p>
          ...
          <InsightCTA
            ...
            description="Model royalty rates, upfronts, and milestones for your specific asset and therapeutic area — powered by 2,600+ real transactions."
          />
        </article>
      </main>
      <SiteFooter />
