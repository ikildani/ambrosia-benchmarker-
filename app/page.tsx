...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-b from-white via-slate-50/50 to-teal-50/30 pt-32 lg:pt-40 pb-24 px-4 overflow-hidden min-h-[90vh] flex items-center">
      ...
      <section id="how-it-works" className="py-24 px-4 bg-gradient-to-b from-slate-50 to-white scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="relative group">
                ...
                <div className="bg-white p-8 rounded-2xl border border-neutral-200 shadow-soft hover:shadow-soft-lg hover:border-teal-200 transition-all duration-500 hover:-translate-y-2">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-soft">
                      {item.step}
                    </div>
          ...
          <div className="text-center mt-12">
            <Link
              href="/calculator"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-teal-600 to-cyan-500 text-white font-semibold px-8 py-4 rounded-xl
                       shadow-lg shadow-teal-500/20 hover:shadow-xl hover:shadow-teal-500/30 transition-all duration-300 hover:-translate-y-0.5"
            >
