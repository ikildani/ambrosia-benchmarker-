...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Quarterly analysis of biopharma licensing deal economics across 12 therapeutic areas from 3,400+ verified transactions.',
    type: 'article',
...
export default function Q1BenchmarkReportPage() {
  ...
  const faqSchema = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: [
    { '@type': 'Question', name: 'What data sources does the Q1 2026 benchmark report use?', acceptedAnswer: { '@type': 'Answer', text: 'The report draws from 3,400+ verified biopharma licensing and M&A transactions (2020-2026). Sources include SEC filings (8-K, 10-K, 10-Q), press releases, and regulatory databases. Updated weekly.' } },
          ...
          <div className="sm:flex items-end gap-10 mb-8">
            <div className="flex-1">
              ...
              <p className="text-base text-slate-500 max-w-xl leading-relaxed">
                A quarterly analysis of licensing economics across 12 therapeutic areas, drawn from 3,400+ verified transactions.
              </p>
            </div>
      ...
      <main className="bg-white">
        ...
        <section className="max-w-4xl mx-auto px-6 pb-16">
          ...
          <div className="divide-y divide-slate-200">
            {[
              { q: 'What data sources does this report use?', a: 'The report draws from 3,400+ verified biopharma licensing and M&A transactions (2020–2026). Sources include SEC filings, press releases, investor presentations, and regulatory databases. Updated weekly via automated monitoring.' },
