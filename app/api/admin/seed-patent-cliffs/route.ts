...
const patentCliffData: Record<string, {
  ...
  'Merck': {
    patent_cliffs: [
      { drug_name: 'Keytruda', indication: 'Oncology (PD-1)', revenue_usd: 25000000000, expiry_year: 2033 },
      { drug_name: 'Gardasil', indication: 'HPV Vaccine', revenue_usd: 6800000000, expiry_year: 2028 },
      { drug_name: 'Januvia', indication: 'Metabolic (DPP-4)', revenue_usd: 2800000000, expiry_year: 2026 },
    ],
  ...
  'Johnson & Johnson': {
    patent_cliffs: [
      ...
      { drug_name: 'Erleada', indication: 'Oncology (Prostate)', revenue_usd: 2500000000, expiry_year: 2032 },
      { drug_name: 'CAPLYTA', indication: 'CNS (Bipolar/Schizophrenia)', revenue_usd: 2800000000, expiry_year: 2037 },
    ],
  ...
  'AbbVie': {
    patent_cliffs: [
      { drug_name: 'Skyrizi', indication: 'Autoimmune (IL-23)', revenue_usd: 10500000000, expiry_year: 2035 },
      { drug_name: 'Rinvoq', indication: 'Autoimmune (JAK)', revenue_usd: 5800000000, expiry_year: 2034 },
      { drug_name: 'Venclexta', indication: 'Hematology (BCL-2)', revenue_usd: 2200000000, expiry_year: 2030 },
      { drug_name: 'Vraylar', indication: 'CNS (D3/D2)', revenue_usd: 3200000000, expiry_year: 2032 },
    ],
    revenue_at_risk_2025: 0,
    revenue_at_risk_2026: 0,
    revenue_at_risk_2027: 0,
  ...
  'Roche': {
    patent_cliffs: [
      ...
      { drug_name: 'Tecentriq', indication: 'Oncology (PD-L1)', revenue_usd: 4100000000, expiry_year: 2030 },
      { drug_name: 'Vabysmo', indication: 'Ophthalmology (VEGF/Ang-2)', revenue_usd: 4500000000, expiry_year: 2036 },
      { drug_name: 'Phesgo', indication: 'Oncology (HER2 SC)', revenue_usd: 2800000000, expiry_year: 2032 },
    ],
    revenue_at_risk_2025: 0,
    revenue_at_risk_2026: 0,
    revenue_at_risk_2027: 0,
  ...
  'Novartis': {
    patent_cliffs: [
      { drug_name: 'Entresto', indication: 'Heart Failure (ARNI)', revenue_usd: 6500000000, expiry_year: 2030 },
      { drug_name: 'Cosentyx', indication: 'Autoimmune (IL-17)', revenue_usd: 5400000000, expiry_year: 2029 },
      { drug_name: 'Kisqali', indication: 'Oncology (CDK4/6)', revenue_usd: 3800000000, expiry_year: 2033 },
      { drug_name: 'Pluvicto', indication: 'Oncology (Radiopharm)', revenue_usd: 1500000000, expiry_year: 2037 },
    ],
    revenue_at_risk_2025: 0,
    revenue_at_risk_2026: 0,
    revenue_at_risk_2027: 0,
  ...
  'AstraZeneca': {
    patent_cliffs: [
      ...
      { drug_name: 'Lynparza', indication: 'Oncology (PARP)', revenue_usd: 2700000000, expiry_year: 2032 },
      { drug_name: 'Enhertu', indication: 'Oncology (ADC)', revenue_usd: 3500000000, expiry_year: 2035 },
    ],
    revenue_at_risk_2025: 0,
    revenue_at_risk_2026: 0,
    revenue_at_risk_2027: 0,
  ...
  'Bayer': {
    patent_cliffs: [
      { drug_name: 'Eylea', indication: 'Ophthalmology (VEGF)', revenue_usd: 2300000000, expiry_year: 2027 },
      { drug_name: 'Nubeqa', indication: 'Oncology (Prostate)', revenue_usd: 1200000000, expiry_year: 2032 },
      { drug_name: 'Kerendia', indication: 'CKD (MRA)', revenue_usd: 1500000000, expiry_year: 2035 },
    ],
    revenue_at_risk_2025: 0,
    revenue_at_risk_2026: 0,
