...
const BULK_QUERIES: BulkQuery[] = [
  ...
  { id: 'all-mid-2022', ta: 'multi', query: 'List biopharma licensing deals and collaborations announced in 2022 with total deal values between $100M and $1B. Include option agreements, co-developments, and research collaborations. For EACH deal provide: both company names, asset name, therapeutic area, phase, financial terms, announced date, and source URL.' },

  // ═══ 2021 ══════════════════════════════════════════════════════════
  { id: 'all-major-2021', ta: 'multi', query: 'List the 30 largest biopharma licensing deals and acquisitions announced in 2021 by total deal value. Include AstraZeneca/Alexion ($39B), Merck/Acceleron ($11.5B), Baxter/Hillrom ($10.5B), Jazz/GW Pharma ($7.2B), Sanofi/Translate Bio ($3.2B), Roche/GenMark ($1.8B), AbbVie/TeneoOne ($1B), Gilead/MYR GmbH ($1.4B), Pfizer/Trillium ($2.3B), Bayer/Vividion ($2B), Novartis/Arctos Medical ($1.6B). For EACH provide: company names, asset, TA, phase, deal type, financial terms, date, source URL.' },
  ...
  // ═══ 2020 ══════════════════════════════════════════════════════════
  { id: 'all-major-2020', ta: 'multi', query: 'List the 30 largest biopharma licensing deals and acquisitions announced in 2020 by total deal value. Include AstraZeneca/Alexion (announced Dec), Gilead/Immunomedics ($21B), BMS/MyoKardia ($13.1B), AbbVie/Allergan ($63B close), Sanofi/Principia ($3.7B), Gilead/Forty Seven ($4.9B), Roche/Inflazome, Merck/VelosBio ($2.75B), AstraZeneca/Daiichi Sankyo Enhertu expansion. Include COVID deals: Pfizer/BioNTech, Moderna/Lonza, Gilead remdesivir. For EACH provide: company names, asset, TA, phase, deal type, financial terms, date, source URL.' },
  { id: 'all-mid-2020', ta: 'multi', query: 'List biopharma licensing deals and collaborations announced in 2020 with total deal values between $100M and $1B. Include COVID-19 partnerships and non-COVID deals. For EACH deal provide: both company names, asset name, therapeutic area, phase, financial terms, announced date, and source URL.' },

  // ═══ 2019 ══════════════════════════════════════════════════════════
  { id: 'all-major-2019', ta: 'multi', query: 'List the 30 largest biopharma licensing deals and acquisitions announced in 2019 by total deal value. Include BMS/Celgene ($74B), AbbVie/Allergan ($63B announced), Roche/Spark ($4.3B), Pfizer/Array ($11.4B), Novartis/The Medicines Company ($9.7B), Merck/ArQule ($2.7B), AstraZeneca/Daiichi Sankyo ($6.9B Enhertu), Amgen/Otezla ($13.4B), Sanofi/Synthorx ($2.5B), Gilead/Galapagos ($5.1B). For EACH provide: company names, asset, TA, phase, deal type, financial terms, date, source URL.' },
  ...
  // ═══ 2018 ══════════════════════════════════════════════════════════
  { id: 'all-major-2018', ta: 'multi', query: 'List the 30 largest biopharma licensing deals and acquisitions announced in 2018 by total deal value. Include Takeda/Shire ($62B), Sanofi/Ablynx ($4.8B), Sanofi/Bioverativ ($11.6B), Celgene/Juno ($9B), Celgene/Impact Biomedicines ($7B), Novartis/AveXis ($8.7B), Novartis/Endocyte ($2.1B), Roche/Foundation Medicine ($2.4B), GlaxoSmithKline/Tesaro ($5.1B), Eli Lilly/Armo BioSciences ($1.6B), Pfizer/Therachon. For EACH provide: company names, asset, TA, phase, deal type, financial terms, date, source URL.' },
  ...
  // ═══ 2017 ══════════════════════════════════════════════════════════
  { id: 'all-major-2017', ta: 'multi', query: 'List the 30 largest biopharma licensing deals and acquisitions announced in 2017 by total deal value. Include J&J/Actelion ($30B), Gilead/Kite ($11.9B), Merck KGaA/Pfizer Bavencio alliance expansion, BMS/IFM Therapeutics ($2.3B), AbbVie/Stemcentrx, Takeda/Ariad ($5.2B), AstraZeneca/Innate Pharma collaboration. For EACH provide: company names, asset, TA, phase, deal type, financial terms, date, source URL.' },
  ...
  { id: 'china-2024-2026', ta: 'multi', query: 'List ALL China biotech out-licensing deals to US and European pharma companies from 2024, 2025, and 2026. Include all ADC, bispecific, small molecule, and cell therapy out-licensing from Chinese biotechs. Include deals by BeiGene, Hengrui, CSPC, 3SBio, Akeso, Zymeworks, Innovent, Legend, RemeGen, WuXi, Harbour BioMed. For EACH deal provide: Chinese company name, Western partner name, asset name, therapeutic area, financial terms, and source URL.' },
  { id: 'china-2020-2023', ta: 'multi', query: 'List ALL China biotech out-licensing deals to US and European pharma companies from 2020 to 2023. Include Legend/J&J (CARVYKTI), BeiGene/Novartis (tislelizumab), Zymeworks/multiple partners, Innovent/Lilly, WuXi Biologics collaborations. For EACH deal provide: Chinese company, Western partner, asset name, TA, financial terms, and source URL.' },
  { id: 'china-2017-2019', ta: 'multi', query: 'List ALL China biotech out-licensing deals to US and European pharma companies from 2017 to 2019. Include early China-to-West deals by BeiGene, Zai Lab, Hutchmed, CStone, and others. For EACH deal provide: Chinese company, Western partner, asset name, TA, financial terms, and source URL.' },
];
