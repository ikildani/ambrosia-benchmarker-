...
const GAP_QUERIES: GapQuery[] = [
  ...
  { ta: 'oncology', yearRange: '2017-2020', query: 'List ALL Japanese and Korean biotech/pharma licensing deals and acquisitions from 2017 to 2020 with disclosed financial terms. Include Takeda, Astellas, Daiichi Sankyo, Eisai, Ono Pharmaceutical, Shionogi out-licensing and in-licensing deals. For EACH provide: both company names, asset name, TA, phase, financial terms, announced date, and source URL.' },

  // ── European pharma & biotech ──────────────────────────────────────
  { ta: 'oncology', yearRange: '2020-2023', query: 'List ALL biopharma licensing deals and acquisitions from 2020 to 2023 involving ANY European company (headquartered in UK, Germany, France, Switzerland, Denmark, Netherlands, Belgium, Italy, Spain, Sweden, Ireland, or elsewhere in Europe) with disclosed financial terms. Include both European companies licensing to/from global partners AND European acquisitions. Not limited to large pharma — include mid-cap and biotech companies. For EACH provide: both company names, asset name, TA, phase, deal type, financial terms, date, and source URL.' },
  { ta: 'oncology', yearRange: '2023-2026', query: 'List ALL biopharma licensing deals and acquisitions from 2023 to 2026 involving ANY European-headquartered company with disclosed financial terms. Include large pharma, mid-cap, and biotech from UK, Germany, France, Denmark, Netherlands, Belgium, Italy, Spain, Sweden, Ireland, and all other European countries. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },
  { ta: 'oncology', yearRange: '2017-2020', query: 'List ALL biopharma licensing deals and acquisitions from 2017 to 2020 involving ANY European-headquartered company with disclosed financial terms over $100M. Include all European pharma and biotech companies, not just the largest. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── Canadian biotech ───────────────────────────────────────────────
  { ta: 'oncology', yearRange: '2017-2023', query: 'List ALL biopharma licensing deals and acquisitions from 2017 to 2023 involving ANY Canadian-headquartered biotech or pharma company with disclosed financial terms. Include all companies listed on TSX or headquartered in Canada. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },
  { ta: 'oncology', yearRange: '2023-2026', query: 'List ALL biopharma licensing deals and acquisitions from 2023 to 2026 involving ANY Canadian-headquartered biotech or pharma company with disclosed financial terms. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── Australia/New Zealand biotech ──────────────────────────────────
  { ta: 'oncology', yearRange: '2017-2023', query: 'List ALL biopharma licensing deals and acquisitions from 2017 to 2023 involving ANY Australian or New Zealand-headquartered biotech or pharma company with disclosed financial terms. Include all ASX-listed and NZX-listed life sciences companies. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },
  { ta: 'oncology', yearRange: '2023-2026', query: 'List ALL biopharma licensing deals and acquisitions from 2023 to 2026 involving ANY Australian or New Zealand-headquartered company with disclosed financial terms. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── Israel biotech ─────────────────────────────────────────────────
  { ta: 'oncology', yearRange: '2017-2022', query: 'List ALL biopharma licensing deals and acquisitions from 2017 to 2022 involving ANY Israeli-headquartered biotech or pharma company with disclosed financial terms. Include all TASE-listed life sciences companies and Israeli startups. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },
  { ta: 'oncology', yearRange: '2022-2026', query: 'List ALL biopharma licensing deals and acquisitions from 2022 to 2026 involving ANY Israeli-headquartered company with disclosed financial terms. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── Latin America pharma ───────────────────────────────────────────
  { ta: 'oncology', yearRange: '2017-2026', query: 'List ALL biopharma licensing deals from 2017 to 2026 involving ANY company headquartered in Latin America (Brazil, Mexico, Argentina, Colombia, Chile, Peru, or elsewhere in Central/South America) with disclosed financial terms. Include both regional pharma and biotech-to-global partnerships. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── Middle East & North Africa ─────────────────────────────────────
  { ta: 'oncology', yearRange: '2017-2026', query: 'List ALL biopharma licensing deals from 2017 to 2026 involving ANY company headquartered in the Middle East or North Africa (UAE, Saudi Arabia, Jordan, Egypt, Morocco, Turkey, Israel excluded as separate category) with disclosed financial terms. Include regional pharma and biotech partnerships with global companies. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── India pharma (major out-licensing and in-licensing) ────────────
  { ta: 'oncology', yearRange: '2020-2026', query: 'List ALL biopharma licensing deals and acquisitions from 2020 to 2026 involving ANY Indian-headquartered biotech or pharma company with disclosed financial terms. Include all NSE/BSE-listed pharma and biotech. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },
  { ta: 'oncology', yearRange: '2017-2020', query: 'List ALL biopharma licensing deals from 2017 to 2020 involving ANY Indian-headquartered company with disclosed financial terms. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── Switzerland biotech (beyond Roche/Novartis) ────────────────────
  { ta: 'oncology', yearRange: '2017-2026', query: 'List ALL biopharma licensing deals and acquisitions from 2017 to 2026 involving ANY Swiss-headquartered biotech or pharma company (excluding Roche and Novartis which are covered elsewhere) with disclosed financial terms. Include all SIX-listed life sciences companies. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ═══════════════════════════════════════════════════════════════════
  // SMALL/MID DEALS ($10M-$100M) — early-stage, platform, option deals
  // These fill the gap below the $100M+ mega-deal queries and provide
  // critical comparables for preclinical/Phase 1 assets and novel modalities.
  // ═══════════════════════════════════════════════════════════════════

  // ── Small deals by year range (all TAs, $10M-$100M) ───────────────
  { ta: 'oncology', yearRange: '2022-2024', query: 'List biopharma licensing deals, option agreements, and collaborations announced in 2022, 2023, and 2024 with disclosed upfront payments or total deal values between $10M and $100M across ALL therapeutic areas. Focus on preclinical and Phase 1 assets. Include option-to-license deals, platform licensing, and regional rights deals. For EACH provide: both company names, asset name, therapeutic area, development phase, deal type, upfront payment, milestones, total deal value, royalty rates if disclosed, announced date, and source URL.' },
  { ta: 'oncology', yearRange: '2024-2026', query: 'List biopharma licensing deals, option agreements, and collaborations announced in 2024, 2025, and 2026 with disclosed upfront payments or total deal values between $10M and $100M across ALL therapeutic areas. Include option-to-license deals, platform licensing, regional rights, and co-development deals for early-stage assets. For EACH provide: both company names, asset name, TA, phase, deal type, upfront, milestones, total value, royalties, date, and source URL.' },
  { ta: 'oncology', yearRange: '2019-2021', query: 'List biopharma licensing deals and option agreements announced in 2019, 2020, and 2021 with disclosed financial terms between $10M and $100M total value across ALL therapeutic areas. Include preclinical and Phase 1 deals, platform licensing, regional rights, and co-development collaborations. For EACH provide: both company names, asset name, TA, phase, deal type, financial terms, date, and source URL.' },
  { ta: 'oncology', yearRange: '2017-2019', query: 'List biopharma licensing deals and option agreements announced in 2017, 2018, and 2019 with disclosed financial terms between $10M and $100M total value across ALL therapeutic areas. Include preclinical deals, platform technology licensing, and early-stage collaborations. For EACH provide: both company names, asset name, TA, phase, deal type, financial terms, date, and source URL.' },

  // ── Novel modality small deals (ADC, gene therapy, cell therapy, mRNA, oligos) ──
  { ta: 'oncology', yearRange: '2020-2026', query: 'List ALL antibody-drug conjugate (ADC) licensing deals from 2020 to 2026 with disclosed financial terms under $500M total value. Include platform-level ADC technology licensing, linker-payload licensing, and single-asset ADC deals at any development stage. For EACH provide: both company names, asset or platform name, TA, phase, deal structure (upfront, milestones, royalties), date, and source URL.' },
  { ta: 'oncology', yearRange: '2020-2026', query: 'List ALL gene therapy and cell therapy licensing deals from 2020 to 2026 with disclosed financial terms under $500M total value. Include AAV gene therapy, base editing, CRISPR-based, CAR-T, CAR-NK, TIL therapy, and iPSC-derived cell therapy licensing deals. For EACH provide: both company names, asset or platform name, TA, phase, deal structure, date, and source URL.' },
  { ta: 'oncology', yearRange: '2020-2026', query: 'List ALL mRNA therapeutics, oligonucleotide (ASO, siRNA, saRNA), and RNA-based drug licensing deals from 2020 to 2026 with disclosed financial terms. Include platform licensing, target-specific licensing, and delivery technology licensing deals at any value. For EACH provide: both company names, asset or platform name, TA, phase, deal structure, date, and source URL.' },
  { ta: 'oncology', yearRange: '2020-2026', query: 'List ALL radiopharmaceutical and radioligand therapy licensing deals from 2020 to 2026 with disclosed financial terms at any value. Include targeted alpha therapy, lutetium-based, and actinium-based deals. For EACH provide: both company names, asset name, TA, phase, deal structure, date, and source URL.' },
  { ta: 'oncology', yearRange: '2020-2026', query: 'List ALL bispecific antibody, trispecific antibody, and T-cell engager licensing deals from 2020 to 2026 with disclosed financial terms under $1B total value. Include all formats: BiTE, DuoBody, CrossMAb, DVD-Ig, and other bispecific platforms. For EACH provide: both company names, asset or platform name, TA, phase, deal structure, date, and source URL.' },
  { ta: 'oncology', yearRange: '2017-2020', query: 'List ALL novel modality licensing deals from 2017 to 2020 including ADC, gene therapy, cell therapy, mRNA, oligonucleotide, bispecific antibody, and radiopharmaceutical deals with disclosed financial terms at any value. For EACH provide: both company names, asset name, modality, TA, phase, deal structure, date, and source URL.' },

  // ── AI/computational drug discovery platform deals ─────────────────
  { ta: 'oncology', yearRange: '2020-2026', query: 'List ALL licensing deals and collaborations from 2020 to 2026 involving AI drug discovery or computational biology companies (such as Recursion, Exscientia, Insilico Medicine, Absci, Isomorphic Labs, Relay Therapeutics, Generate Biomedicines, Evotec, Schrödinger, and others) with disclosed financial terms. Include platform collaborations, target discovery deals, and molecule-specific licensing. For EACH provide: both company names, asset or platform name, TA, deal structure (upfront, milestones, royalties, equity), date, and source URL.' },
  { ta: 'oncology', yearRange: '2017-2020', query: 'List ALL early AI drug discovery licensing deals and platform collaborations from 2017 to 2020 with disclosed financial terms. Include deals by Numerate, Atomwise, BenevolentAI, Exscientia, Recursion, Deep Genomics, and other AI-first drug discovery companies. For EACH provide: both company names, platform/asset name, TA, deal structure, date, and source URL.' },

  // ── University spin-out and academic licensing ─────────────────────
  { ta: 'oncology', yearRange: '2020-2026', query: 'List biopharma licensing deals from 2020 to 2026 where a university, academic medical center, or research institute (such as MIT, Stanford, Harvard, NIH, UCSF, Oxford, Cambridge, Weizmann, Broad Institute, Dana-Farber, MD Anderson, Memorial Sloan Kettering) licensed a drug asset or platform technology to a pharma or biotech company with disclosed financial terms. For EACH provide: academic institution, licensee company, asset name, TA, phase, financial terms (upfront, milestones, royalties), date, and source URL.' },
  { ta: 'oncology', yearRange: '2017-2020', query: 'List biopharma licensing deals from 2017 to 2020 where a university or academic institution licensed a drug asset or platform to a pharma or biotech company with disclosed financial terms. Include all therapeutic areas. For EACH provide: academic institution, licensee company, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── Option-to-license and milestone-only deals ─────────────────────
  { ta: 'oncology', yearRange: '2021-2026', query: 'List biopharma option-to-license deals and opt-in agreements from 2021 to 2026 with disclosed option fees, exercise terms, or milestone structures across ALL therapeutic areas. These are deals where one party pays for the right to license an asset upon reaching specific milestones. Include Eli Lilly, Roche, Merck, Pfizer, AstraZeneca, and Novartis option deals with smaller biotechs. For EACH provide: both company names, asset name, TA, phase, option fee, exercise conditions, downstream milestones and royalties, date, and source URL.' },
  { ta: 'oncology', yearRange: '2017-2021', query: 'List biopharma option-to-license deals and research collaboration opt-in agreements from 2017 to 2021 with disclosed financial terms across ALL therapeutic areas. For EACH provide: both company names, asset name, TA, phase, option fee, exercise conditions, milestones, royalties, date, and source URL.' },

  // ── Regional and territorial licensing (ex-US, ex-China, etc.) ────
  { ta: 'oncology', yearRange: '2020-2026', query: 'List biopharma regional or territorial licensing deals from 2020 to 2026 with disclosed financial terms where rights were licensed for specific geographies (e.g., ex-US, ex-China, Greater China, Japan, Europe-only, rest-of-world). These often have smaller upfronts but are critical benchmarks for territory-specific deal structuring. For EACH provide: both company names, asset name, TA, phase, territory licensed, upfront, milestones, royalties, date, and source URL.' },

  // ── Rare disease small deals ──────────────────────────────────────
  { ta: 'rareDisease', yearRange: '2017-2026', query: 'List ALL rare disease and orphan drug licensing deals from 2017 to 2026 with disclosed financial terms under $500M total value. Include gene therapy for rare diseases, enzyme replacement therapy licensing, and small molecule orphan drug deals. For EACH provide: both company names, asset name, specific indication, phase, deal structure (upfront, milestones, royalties), date, and source URL.' },

  // ── Preclinical and discovery-stage deals ──────────────────────────
  { ta: 'oncology', yearRange: '2021-2026', query: 'List biopharma licensing deals from 2021 to 2026 specifically involving PRECLINICAL or DISCOVERY-STAGE assets with disclosed financial terms across ALL therapeutic areas. These deals typically have smaller upfronts ($1M-$50M) but large milestone packages. Include target validation collaborations, lead optimization licensing, and IND-enabling stage deals. For EACH provide: both company names, asset name, TA, development stage, deal structure (upfront, milestones, royalties), date, and source URL.' },
];
