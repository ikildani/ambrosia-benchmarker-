...
const GAP_QUERIES: GapQuery[] = [
  ...
  { ta: 'oncology', yearRange: '2020-2023', query: 'List ALL European biotech and pharma licensing deals and acquisitions from 2020 to 2023 with disclosed financial terms. Include deals by Roche, Novartis, Sanofi, AstraZeneca, GSK, Bayer, Boehringer Ingelheim, UCB, Servier, Ipsen, Merck KGaA, Lundbeck, LEO Pharma, Galapagos, Argenx, BioNTech, CureVac, Genmab, Merus, MorphoSys. For EACH provide: both company names, asset name, TA, phase, deal type, financial terms, date, and source URL.' },
  { ta: 'oncology', yearRange: '2023-2026', query: 'List ALL European biotech and pharma licensing deals and acquisitions from 2023 to 2026 with disclosed financial terms. Include deals by Roche, Novartis, Sanofi, AstraZeneca, GSK, Bayer, Boehringer Ingelheim, UCB, Servier, Ipsen, Merck KGaA, LEO Pharma, Argenx, BioNTech, Genmab, Zealand Pharma, Ascendis, Bavarian Nordic. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },
  { ta: 'oncology', yearRange: '2017-2020', query: 'List ALL European biotech and pharma licensing deals and acquisitions from 2017 to 2020 with disclosed financial terms over $100M. Include deals by Roche, Novartis, Sanofi, AstraZeneca, GSK, Bayer, Boehringer, Shire (pre-Takeda), Actelion (pre-J&J), Ablynx (pre-Sanofi). For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── Canadian biotech ───────────────────────────────────────────────
  { ta: 'oncology', yearRange: '2017-2023', query: 'List ALL Canadian biotech and pharma licensing deals and acquisitions from 2017 to 2023 with disclosed financial terms. Include deals by Bausch Health (Valeant), Aurinia, Zymeworks, Repligen, Xenon Pharmaceuticals, Liminal BioSciences, AbCellera, Notch Therapeutics, Fusion Pharmaceuticals. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },
  { ta: 'oncology', yearRange: '2023-2026', query: 'List ALL Canadian biotech and pharma licensing deals and acquisitions from 2023 to 2026 with disclosed financial terms. Include Zymeworks, AbCellera, Repligen, BELLUS Health, Medicago partnerships. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── Australia/New Zealand biotech ──────────────────────────────────
  { ta: 'oncology', yearRange: '2017-2023', query: 'List ALL Australian and New Zealand biotech and pharma licensing deals and acquisitions from 2017 to 2023 with disclosed financial terms. Include deals by CSL, Mesoblast, Telix Pharmaceuticals, Imugene, Race Oncology, Opthea, Protagonist Therapeutics, Polynovo, Paradigm Biopharmaceuticals. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },
  { ta: 'oncology', yearRange: '2023-2026', query: 'List ALL Australian and New Zealand biotech and pharma licensing deals and acquisitions from 2023 to 2026 with disclosed financial terms. Include CSL, Telix Pharmaceuticals, Mesoblast, and other ANZ biotech partnerships. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── Israel biotech ─────────────────────────────────────────────────
  { ta: 'oncology', yearRange: '2017-2022', query: 'List ALL Israeli biotech and pharma licensing deals and acquisitions from 2017 to 2022 with disclosed financial terms. Include Teva, BioLineRx, Compugen, Can-Fite, Kamada, MediWound, Check-Cap, RedHill Biopharma, Plurilock, Enlivex. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },
  { ta: 'oncology', yearRange: '2022-2026', query: 'List ALL Israeli biotech and pharma licensing deals and acquisitions from 2022 to 2026 with disclosed financial terms. Include Teva, BioLineRx, Compugen, Itamar Medical, CollPlant, NovaBay, Brainstem Biopharmaceuticals, and all Israel-based biotech partnerships. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── Latin America pharma ───────────────────────────────────────────
  { ta: 'oncology', yearRange: '2017-2026', query: 'List ALL Latin American biotech and pharma licensing deals from 2017 to 2026 with disclosed financial terms. Include deals by Eurofarma (Brazil), Genomma Lab (Mexico), Cristalia (Brazil), Sinergium Biotech (Argentina), Probiomed (Mexico), Bagó (Argentina), and any Brazil, Mexico, Argentina, Colombia, Chile biotech/pharma partnerships with global companies. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── Middle East & North Africa ─────────────────────────────────────
  { ta: 'oncology', yearRange: '2017-2026', query: 'List ALL Middle East and North Africa biotech and pharma licensing deals from 2017 to 2026 with disclosed financial terms. Include deals by Julphar (UAE), Saudi Pharmaceutical Industries, Hikma (Jordan), Tabuk Pharmaceuticals (Saudi Arabia), SPIMACO, Gulf Pharmaceutical Industries, Pharma 5 (Morocco), and any MENA region biotech/pharma partnerships with global companies. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── India pharma (major out-licensing and in-licensing) ────────────
  { ta: 'oncology', yearRange: '2020-2026', query: 'List ALL Indian biotech and pharma licensing deals and acquisitions from 2020 to 2026 with disclosed financial terms. Include Sun Pharma, Dr. Reddys, Cipla, Lupin, Aurobindo, Biocon, Glenmark, Zydus Lifesciences, Natco Pharma out-licensing and in-licensing deals with global pharma. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },
  { ta: 'oncology', yearRange: '2017-2020', query: 'List ALL Indian biotech and pharma licensing deals from 2017 to 2020 with disclosed financial terms. Include Sun Pharma, Dr. Reddys, Biocon, Glenmark, Aurobindo partnerships with US and European companies. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },

  // ── Switzerland biotech (beyond Roche/Novartis) ────────────────────
  { ta: 'oncology', yearRange: '2017-2026', query: 'List ALL Swiss biotech licensing deals and acquisitions from 2017 to 2026 with disclosed financial terms. Exclude Roche and Novartis (already covered). Include deals by Basilea, Idorsia, CRISPR Therapeutics, Addex Therapeutics, ObsEva, Polyphor, AC Immune, Gain Therapeutics, Relief Therapeutics, SOPHiA GENETICS. For EACH provide: both company names, asset name, TA, phase, financial terms, date, and source URL.' },
];
