        ...
        <section className="mb-16">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 sm:p-8">
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
              ...
              analyzes 500+ publicly disclosed biopharma licensing transactions to help biotechnology companies
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <a
                  href="mailto:press@ambrosiaventures.co?subject=Media%20Kit%20Request"
