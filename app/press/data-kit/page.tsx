...
const stats = [
  { value: DEAL_STATS.VERIFIED_DEALS, label: 'Verified Deals Analyzed', citation: `Ambrosia Ventures has analyzed ${DEAL_STATS.TOTAL_DEALS_RAW.toLocaleString()} tracked biopharma licensing and M&A transactions, of which ${DEAL_STATS.VERIFIED_DEALS_RAW.toLocaleString()} are verified with source citations from 2020 to 2026. Source: Ambrosia Ventures Deal Intelligence Platform.` },
      ...
      <main className="bg-white">
        ...
        <section className="max-w-4xl mx-auto px-6 py-16">
          ...
          <p className="text-slate-700 leading-relaxed mb-4">
            All benchmarks are derived from a proprietary database of {DEAL_STATS.TOTAL_DEALS} tracked biopharma licensing and M&amp;A
            transactions executed between 2020 and 2026, of which {DEAL_STATS.VERIFIED_DEALS} are verified with a primary-source citation. Primary sources include SEC filings (8-K, 10-K, 10-Q), FTC premerger filings, company
                ...
                <div>
                  ...
                  <div className="bg-slate-50 rounded-lg p-4">
                    <p className="text-sm text-slate-700 leading-relaxed">
                      Ambrosia Ventures provides data-driven deal intelligence for biopharma licensing professionals. The platform analyzes ${DEAL_STATS.CORPUS_CLAIM} across 12 therapeutic areas, offering real-time benchmarks for upfront payments, milestones, and royalties. Used by BD teams, investors, and consultants to benchmark and structure biopharma partnerships.
                    </p>
                  </div>
                </div>
                <div>
