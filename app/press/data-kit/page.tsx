...
const stats = [
  { value: '3,500+', label: 'Verified Deals Analyzed', citation: 'Ambrosia Ventures has analyzed over 3,500 verified biopharma licensing and M&A transactions from 2020 to 2026. Source: Ambrosia Ventures Deal Intelligence Platform.' },
...
export default function PressDataKitPage() {
  ...
  const datasetSchema = { '@context': 'https://schema.org', '@type': 'Dataset', name: 'Ambrosia Ventures Biopharma Deal Benchmarks', description: 'Benchmarks for biopharma licensing deal economics across 12 TAs from 3,500+ verified transactions (2020-2026).', creator: { '@type': 'Organization', name: 'Ambrosia Ventures' }, temporalCoverage: '2020/2026' };
      ...
      <main className="bg-white">
        ...
        <section className="max-w-4xl mx-auto px-6 py-16">
          ...
          <p className="text-slate-700 leading-relaxed mb-4">
            All benchmarks are derived from a proprietary database of 3,500+ verified biopharma licensing and M&amp;A
                ...
                <div>
                  ...
                  <div className="bg-slate-50 rounded-lg p-4">
                    <p className="text-sm text-slate-700 leading-relaxed">
                      Ambrosia Ventures provides data-driven deal intelligence for biopharma licensing professionals. The platform analyzes 3,500+ verified transactions across 12 therapeutic areas, offering real-time benchmarks for upfront payments, milestones, and royalties. Used by BD teams, investors, and consultants to benchmark and structure biopharma partnerships.
                    </p>
                  </div>
                </div>
                <div>
