...
export default function LifeSciencesDealCalculatorGuidePage() {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'The calculator requires a free account to run deal benchmarks. Basic deal term benchmarking is available to all registered users. Advanced engines including Monte Carlo simulation, real options valuation, competitive dynamics, and buyer-specific valuation require a Pro subscription ($299/month or $199/month billed annually). All users receive instant deal term comparisons against 2,500+ real transactions.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'The calculator benchmarks against 2,500+ disclosed biopharma transactions spanning 12 therapeutic areas, 23+ modalities, and all clinical phases from discovery through approved products. The dataset is continuously updated through automated ingestion from SEC EDGAR filings, press releases, and regulatory documents. This is the largest proprietary deal benchmarking dataset available for life sciences professionals.',
        },
      },
      {
        '@type': 'Question',
  ...
  const softwareSchema = {
    ...
    description: 'Life sciences deal benchmarking tool with 14 calculation engines, 2,500+ comparable transactions, and institutional-quality reporting.',
    offers: [
      {
        '@type': 'Offer',
        price: '0',
      ...
      <main className="min-h-screen bg-white">
        ...
        <header className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-24 pb-16 px-4 relative overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-xl text-slate-300 leading-relaxed">
              Powered by 2,500+ real biopharma transactions. Benchmark upfronts, milestones, royalties, rNPV, and Monte Carlo analysis across 12 therapeutic areas and 562 indications.
            </p>
          </div>
        </header>
        ...
        <article className="max-w-3xl mx-auto px-4 py-12">
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <p className="text-slate-600 leading-relaxed">
              The calculator&apos;s benchmarks are only as good as the data behind them. Our dataset of 2,500+ transactions is built from multiple primary sources with rigorous validation:
            </p>
            ...
            <div className="overflow-x-auto my-8">
              <table className="min-w-full text-sm border border-slate-200 rounded-lg overflow-hidden">
                ...
                <tbody className="divide-y divide-slate-100">
                  <tr><td className="px-4 py-3 text-slate-700 font-medium">Comparable deals</td><td className="px-4 py-3 text-slate-600">5-15 manually sourced</td><td className="px-4 py-3 text-slate-600">2,500+ auto-filtered</td></tr>
        ...
        <section className="py-16 px-4 bg-gradient-to-br from-teal-600 to-cyan-600">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-teal-100 mb-8 text-lg">
              Join BD teams, investors, and deal advisors using the calculator to benchmark transactions against 2,500+ real biopharma deals. Create a free account and run your first benchmark in minutes.
            </p>
            <Link
              href="/calculator"
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <details className="group bg-white rounded-xl border border-slate-200 overflow-hidden">
                ...
                <div className="px-6 pb-6 text-slate-600 leading-relaxed">
                  The calculator benchmarks against 2,500+ disclosed biopharma transactions spanning 12 therapeutic areas, 23+ modalities, and all clinical phases. The dataset is continuously updated through automated ingestion from SEC EDGAR, press releases, ClinicalTrials.gov, and regulatory filings.
                </div>
              </details>
