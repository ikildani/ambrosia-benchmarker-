...
export const metadata: Metadata = {
  title: 'Biopharma Licensing Benchmarks 2026: Data From 2,500+ Deals | Ambrosia Ventures',
  description: 'Comprehensive biopharma licensing benchmarks for 2026 including upfront payments, milestones, royalties by phase, modality, and therapeutic area. Based on 2,500+ disclosed transactions.',
  keywords: [
...
export default function BiopharmaLicensingBenchmarksPage() {
  ...
  const articleSchema = {
    '@context': 'https://schema.org',
    '@type': 'Article',
    headline: 'Biopharma Licensing Benchmarks 2026: Data From 2,500+ Deals',
        ...
        <article className="max-w-3xl mx-auto px-4 py-12">
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <div className="my-10 p-6 bg-gradient-to-r from-slate-50 to-teal-50 rounded-xl border border-teal-100">
              <h3 className="text-lg font-semibold text-slate-900 mb-2">Benchmark your deal against 2,500+ transactions</h3>
        ...
        <section className="py-16 px-4 bg-slate-50 border-t border-slate-200">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                { href: '/calculator', title: 'Deal Calculator', desc: 'Benchmark your deal against 2,500+ transactions' },
