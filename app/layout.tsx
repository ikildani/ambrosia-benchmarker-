...
export const metadata: Metadata = {
  ...
  description: "Instant deal benchmarks, rNPV analysis, Monte Carlo simulation, and real-time market intelligence for biopharma licensing deals across 12 therapeutic areas. 3,400+ real transactions, 850+ company profiles. Free to start.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "rNPV modeling, Monte Carlo simulation, and AI market intelligence for biopharma licensing deals. 3,400+ real transactions, 850+ company profiles, 12 therapeutic areas. Free to start.",
    type: "website",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Life Sciences Deal Calculator — Instant benchmarks from 3,400+ real biopharma licensing transactions",
      },
    ],
  },
  twitter: {
    ...
    title: "Life Sciences Deal Calculator — Instant Biopharma Licensing Benchmarks",
    description: "rNPV, Monte Carlo & AI deal intelligence for biopharma licensing. 3,400+ deals, 850+ companies, 12 TAs. Free to start.",
    images: ["/api/og"],
    creator: "@AmbrosiaVC",
    site: "@AmbrosiaVC",
  },
