...
export const metadata: Metadata = {
  ...
  description: `Deal benchmarks across 12 TAs: oncology, neurology, immunology, rare disease & more. Licensing, M&A, royalty data from ${DEAL_STATS.TOTAL_DEALS} tracked deals, ${DEAL_STATS.VERIFIED_DEALS} verified with source citations.`,
...
const TAS = [
  ...
  { slug: 'immunology', name: 'Immunology', icon: '🛡️', tagline: '$13B+ in tracked deal value' },
    ...
    <main className="min-h-screen bg-white dark:bg-slate-900 py-16 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-lg text-slate-600 dark:text-slate-400 mb-10">
          Explore licensing, acquisition, and collaboration deal terms across 12 therapeutic areas, powered by {DEAL_STATS.TOTAL_DEALS} tracked transactions, {DEAL_STATS.VERIFIED_DEALS} verified with source citations with disclosed financial terms.
        </p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "description": `Deal benchmarks across 12 therapeutic areas including oncology, neurology, immunology, rare disease, and more. Licensing, M&A, and royalty data from ${DEAL_STATS.TOTAL_DEALS} tracked biopharma transactions, ${DEAL_STATS.VERIFIED_DEALS} verified with source citations.`,
        "url": "https://solidus.ambrosiaventures.co/therapeutic-areas",
