        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 lg:h-20">
            ...
            <div className="flex items-center gap-3">
              {/* Pro Badge */}
              {tier === 'pro' && (
                <span className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-amber-100 to-yellow-100 border border-amber-200 rounded-full text-xs font-semibold text-amber-700">
              ...
              {tier === 'free' && (
                <button
                  ...
                  className="hidden sm:inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-teal-600 hover:text-teal-700 bg-teal-50 hover:bg-teal-100 rounded-xl transition-colors"
                >
              ...
              {isAuthenticated ? (
                <div className="relative" ref={menuRef}>
                  <button
                    ...
                    className="flex items-center gap-2 p-1.5 pr-3 rounded-full bg-slate-50 hover:bg-slate-100 border border-slate-200 transition-all duration-200"
                  >
      ...
      <main className="pt-24 lg:pt-28 pb-16 px-4">
        ...
        {tier === 'free' && (
          <div className="max-w-6xl mx-auto mt-12">
            <div className="bg-gradient-to-br from-navy-900 via-navy-800 to-navy-900 rounded-2xl p-8 relative overflow-hidden">
              ...
              <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <button
                  onClick={handleUpgrade}
                  className="flex-shrink-0 inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-teal-500 to-cyan-500 text-white font-semibold rounded-xl shadow-glow hover:shadow-glow-lg transition-all duration-200 hover:-translate-y-0.5"
                >
