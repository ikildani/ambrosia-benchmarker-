...
export const metadata: Metadata = {
  ...
  description: 'Calculate upfront payments, milestone structures, and royalty rates for biopharma licensing deals. rNPV analysis, Monte Carlo simulation, sensitivity analysis, and AI deal memos across oncology, neurology, immunology, metabolic, cardiovascular, and more. Powered by 3,400+ real transactions.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Calculate upfront payments, milestones, and royalties with rNPV analysis and Monte Carlo simulation. 3,400+ real biopharma transactions, 12 therapeutic areas.',
    type: 'website',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Ambrosia Ventures Deal Calculator — rNPV, Monte Carlo, and benchmarks from 3,400+ real biopharma deals',
      },
    ],
  },
  twitter: {
    ...
    title: 'Deal Terms Calculator — Instant Biopharma Licensing Benchmarks',
    description: 'rNPV analysis, Monte Carlo simulation, and AI deal intelligence from 3,400+ real transactions. 12 therapeutic areas.',
  },
  alternates: {
