    ...
    <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-sm">
      <div className="flex items-center gap-2 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">Manage your password and account settings</p>
        </div>
      </div>
      <div className="grid sm:grid-cols-2 gap-3">
        <button
          onClick={() => {
            ...
            setTimeout(() => {
              const pwBtn = document.querySelector('[data-password-toggle]') as HTMLElement;
        ...
        <button
          ...
          className="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors text-left"
        >
          <div className="w-9 h-9 rounded-lg bg-slate-200 dark:bg-slate-600 flex items-center justify-center shrink-0">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">Profile, preferences, and subscription</p>
          </div>
        </button>
      </div>
    </div>
