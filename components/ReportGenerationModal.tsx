            ...
            <div className="flex items-center justify-between mb-4">
              ...
              {!isProcessing && (
                <button
                  ...
                  className="w-11 h-11 p-2.5 rounded-lg flex items-center justify-center text-neutral-400 hover:text-neutral-600 dark:text-slate-500 dark:hover:text-slate-300 hover:bg-neutral-100 dark:hover:bg-slate-700 transition-colors"
                  aria-label="Close"
                >
