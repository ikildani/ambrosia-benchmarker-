...
export default function MainContent() {
  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-b from-white via-slate-50/50 to-teal-50/30 pt-44 lg:pt-60 pb-20 px-4 overflow-hidden min-h-[88vh] flex items-center">
