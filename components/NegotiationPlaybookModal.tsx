          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-neutral-300 text-xs sm:text-sm">AI-powered strategic advice</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        {playbook && !loading && !error && (
          <div className="p-4 sm:p-6 border-t border-neutral-200 bg-neutral-50 print:hidden">
            ...
            <p className="text-center text-xs text-neutral-400 mt-4">
              Generated by Claude AI • Tailored to your specific inputs • Not legal or financial advice
            </p>
          </div>
        )}
      </div>
