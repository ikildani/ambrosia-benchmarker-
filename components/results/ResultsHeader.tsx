    ...
    <div className="relative bg-gradient-to-br from-navy-900 via-navy-800 to-navy-900 px-4 sm:px-6 lg:px-8 xl:px-10 py-4 sm:py-5 lg:py-6 xl:py-8 overflow-hidden">
      ...
      <div className="relative space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-2 pt-1">
          ...
          <button onClick={onXShare} className="inline-flex items-center gap-1.5 px-3 py-3 sm:py-2.5 bg-white/10 hover:bg-white/20 text-white text-xs font-medium rounded-lg transition-all border border-white/10 hover:border-white/20">
            <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span className="hidden sm:inline">Post</span>
          </button>
          <button onClick={onEmailShare} className="inline-flex items-center gap-1.5 px-3 py-3 sm:py-2.5 bg-white/10 hover:bg-white/20 text-white text-xs font-medium rounded-lg transition-all border border-white/10 hover:border-white/20">
