...
const faqs = [
  {
    ...
    answer: `Enter your asset's details — modality, development phase, indication, and deal type — and our engine analyzes ${DEAL_STATS.TOTAL_DEALS} tracked biopharma transactions, ${DEAL_STATS.VERIFIED_DEALS} verified with source citations to generate benchmark ranges for upfront payments, milestones, royalties, and total deal value. Pro subscribers also get risk-adjusted NPV (rNPV) with Monte Carlo simulation, AI-generated deal memos, negotiation playbooks, partner matching, and branded exports. Results are generated in under 30 seconds.`
  },
  {
