...
const faqs = [
  {
    ...
    answer: `Enter your asset's key details — modality, development phase, indication, and territory — and our calculator analyzes ${SITE_CONFIG.dealsAnalyzed} real biopharma licensing deals to generate benchmark ranges for upfront payments, milestones, and royalty rates. You get a data-driven starting point for any deal conversation in seconds.`
  },
  {
  ...
  },
  {
    ...
    answer: `We currently cover oncology and neurology/CNS — the two most active therapeutic areas in biopharma licensing. Oncology benchmarks draw from ${SITE_CONFIG.dealsAnalyzed} deals, while our neurology module is calibrated against ${SITE_CONFIG.neurologyPartnerships} R&D partnerships totaling $45.9B (2024-2025), covering indications from Alzheimer's to rare neurological diseases. Additional therapeutic areas including immunology and cardiometabolic are in development.`
  },
  {
