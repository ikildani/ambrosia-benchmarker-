...
const comparisonRows = [
  ...
  { feature: 'Data coverage', manual: '1-2 databases', ambrosia: `${DEAL_STATS.TOTAL_DEALS} deals from SEC, FTC, press releases & regulatory databases` },
  ...
  { feature: 'Partner intelligence', manual: 'Relationship-based', ambrosia: '700+ company profiles with deal history' },
