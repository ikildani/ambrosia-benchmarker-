    ...
    <div className="relative">
      ...
      <div className="relative -mt-4 rounded-xl border border-teal-500/20 bg-slate-900/95 backdrop-blur-sm p-6 sm:p-8">
        <div className="max-w-lg mx-auto text-center">
          ...
          <Link
            href="/pro"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-500 text-white text-sm font-semibold hover:from-teal-700 hover:to-cyan-600 transition-all shadow-lg shadow-teal-500/20"
          >
          ...
          <p className="text-xs text-slate-500 mt-3">$299/mo after trial · Cancel anytime</p>
        </div>
      </div>
    </div>
  );
