  ...
  return (
    <div className="my-10 border border-slate-200 rounded-xl overflow-hidden">
      ...
      <div className="bg-slate-50 px-5 py-2.5 border-t border-slate-200">
        <p className="text-xs text-slate-400">Data sourced from {DEAL_STATS.TOTAL_DEALS} tracked biopharma transactions, {DEAL_STATS.VERIFIED_DEALS} verified with source citations. Updated monthly.</p>
      </div>
    </div>
  );
}
