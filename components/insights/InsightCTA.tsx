    ...
    return (
      <section className="my-12 bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 rounded-2xl p-8 sm:p-10 text-center">
        ...
        <p className="text-slate-300 mb-6 max-w-xl mx-auto">
          {description || 'Model upfronts, milestones, and royalties for your specific asset — powered by 3,400+ real transactions.'}
        </p>
        <Link
          href={calculatorHref}
    ...
    <section className="py-20 px-4 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-lg text-slate-300 mb-8 leading-relaxed">
          {description || 'Model upfronts, milestones, and royalties for any phase, modality, and therapeutic area — powered by 3,400+ real transactions.'}
        </p>
